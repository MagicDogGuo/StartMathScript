...
[CustomEditor(typeof(MatchASumSourse))]
public class MatchASumEditor : Editor {

    USceneSelector selector;

    MatchASumSourse Instance;
    bool moveItemsFoldout = true;
    bool matchPosFoldout = true;
    bool IsOpenOriginInspector = false;
    bool matchIdArrayFoldout = true;
    private void OnEnable()
    {
        Instance = (MatchASumSourse)target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (moveItemsFoldout)
        {
            ...
            UEditorGUI.ArrayEditor(serializedObject.FindProperty("MoveItems"), typeof(MoveItem_matchASum), MoveItem_ArrayEditorMiddle, MoveItem_ArrayEditorTrail);
        ...
        if (matchPosFoldout)
        {
            UEditorGUI.ArrayEditor(serializedObject.FindProperty("MatchPosItems"), typeof(MatchPosItem_matchASum), MatchItemPost_ArrayEditorMiddle, MatchItemPost_ArrayEditorTrail);
